...
The school takes place from **16th to 20th September 2024** and it is held at the premises of the **Institute of Archaeology, Czech Academy of Sciences, Brno** ([https://arub.cz/](https://arub.cz/){.external}), the address is:
...
1. **Apply via official form** of the ATRIUM project (see section [Applications](applications.qmd) for details) containing personal details and motivation for participation.
2. **Participate in person**, i.e. sign attendance sheets for each day of the school.
3. **Submit a report** within a given time frame after the school with details on their participation.
