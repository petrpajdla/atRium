...
format:
  revealjs:
    ...
    footer: "[atRium](https://petrpajdla.github.io/atRium/) *training school*, Brno 2024 | [Data viz](/dataviz/index.qmd)"
    logo: /figs/Clay.png
    chalkboard:
      theme: whiteboard
      chalk-effect: 0.0
...
![](figs/fig4_book.jpg){.nostretch width="60%"}
:::
::: {.column width=48%}
[The R Graph Gallery](https://r-graph-gallery.com/)  
![](figs/fig5_graph_galery.png){.nostretch width="120%"}
:::
::::
...
![](figs/fig2_shape.png){.nostretch width="50%"}
